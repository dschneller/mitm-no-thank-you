...
/*!
 ...
 it is supported. Puts out a bit of logging. If the protection space is NOT supported,
 the connection will be cancelled automatically before returning.
 
 \param challenge The authentication challenge provided for the connection
...
/*!
 ...
 The implementation subclasses are reponsible to do the right thing.
